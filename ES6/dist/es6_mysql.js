...
var seq = new Sequelize('es6', 'root', '123456', { dialect: 'mysql' }); // new的对象首字母大写
//数据库名，用户名，密码，方言（指定数据库类型）

//2、定义数据库中的数据格式，数据名字和数据类型
//sequelize.INTEGER===整数
//point:定义数据模型
var Point = seq.define('point', { //定义数据模型，point数据库表名称，再数据库生成时会自动加s
    x: Sequelize.INTEGER,
    y: Sequelize.INTEGER
}, {
